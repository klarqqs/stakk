...
class PasscodeGateScreen extends StatefulWidget {
  const PasscodeGateScreen({super.key});

  @override
  State<PasscodeGateScreen> createState() => _PasscodeGateScreenState();
}

class _PasscodeGateScreenState extends State<PasscodeGateScreen> {
  String _passcode = '';
  String? _error;
  ...
  Future<void> _verify() async {
    final stored = await _storage.read(key: StorageKeys.passcode);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Use your 4-digit passcode to unlock',
